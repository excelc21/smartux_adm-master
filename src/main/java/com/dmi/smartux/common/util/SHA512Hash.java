...
public class SHA512Hash 
{
	...
	public static String hashToBase64(String str, String charset)
	{
		try
		{
			...
			// sun.misc.BASE64Encoder 클래스는 더 이상 사용하면 안되는 클래스여서 Apache에서 제공하는 클래스로 변경
	...
	public static void main(String args[])
	{
		//if (args.length < 1)
		//{
		//	System.out.println("Usage: java SHA512Hash <text>");
		//	return;
		//}

		//String charset = "euc-kr";
		//System.out.println("hex encoded = " + SHA512Hash.hashToHex(args[0], charset));
		//System.out.println("base64 encoded = " + SHA512Hash.hashToBase64(args[0], charset));
