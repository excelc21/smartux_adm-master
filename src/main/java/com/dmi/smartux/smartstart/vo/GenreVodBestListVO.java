...
@XmlType(name="GenreVodBestListVO", namespace="com.dmi.smartux.smartstart.vo.GenreVodBestListVO", propOrder={"rank_no","album_id","cat_id","album_title","img_url","w_img", "h_img","series_flag","series_desc","close_yn","is_hd","program_info","onair_date","is_caption","genre1","release_date","watch_right_yn","is_fh","category_name"})
@XmlAccessorType(XmlAccessType.NONE)
public class GenreVodBestListVO extends BaseVO  implements Serializable, Cloneable{ 

	private static final long serialVersionUID = -7851139224932128045L;
	...
	public Object clone() throws CloneNotSupportedException{
		GenreVodBestListVO gVo = (GenreVodBestListVO)super.clone();
		return gVo;
	}
