...
<script type="text/javascript">
	...
	function fn_selectChnl(channel_no, channel_name, service_id, channel_id){
		...
		if(confirm(msg + " 채널을 선택하시겠습니까?")){
			...
			if("${opener}" == "trigger"){
				window.opener.jQuery("#${target}").val(service_id);
			} 
						                ...
						                <tr>
						                    <td>
						                        <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                       	...
						                       	<form id="srchfrm" name="srchfrm" method="post" action="<%=webRoot%>/admin/trigger/getChannelInfo.do">
						                            ...
						                            <tr>
						                            	<td align="center">
						                            		<jsp:include page="/WEB-INF/views/include/gpack_naviControll.jsp">
																<jsp:param value="/smartux_adm/admin/trigger/getChannelInfo.do" name="actionUrl"/>
