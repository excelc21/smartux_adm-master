...
function fn_save_contents(){
	...
	if(!use_yn){
		...
		var postUrl = "<%=webRoot%>/admin/gpack/contents/insertGpackContentsAuto.do";
                    				...
                    				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                ...
						                <tr>
						                    <td>
						                                ...
						                                <td height="25">
						                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
						                                        ...
						                                        <tr>
						                                            ...
						                                            <td class="bold">VOD 자동설정 상세조회</td>
						                                        </tr>
						                                    	</tbody>
						                                    </table>
						                                </td>
						                        ...
						                        <input type="hidden" id="pack_id"		name="pack_id"		value="${autoVO.pack_id }"/>
						                        <input type="hidden" id="category_id"	name="category_id"	value="${autoVO.category_id }"/>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="450px" class="board_data">
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="70%" align="left" >
						                                    <input type="text" id="category_nm" name="category_nm" value="${autoVO.category_nm}" size="35" maxlength="100" style="font-size: 12px;" disabled="disabled"/>
														</td>
					                                </tr>
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="5%"></td>
					                                    <td width="70%" align="left" >
					                                    	<input type="radio" name="order_type" value="AT001" <c:if test="${autoVO.order_type ne 'AT002' }">checked="checked"</c:if> />최신순
					                                    	<input type="radio" name="order_type" value="AT002" <c:if test="${autoVO.order_type eq 'AT002' }">checked="checked"</c:if> />가나다순
														</td>
					                                </tr>
					                                --%>
					                                <tr align="center">
					                                    ...
					                                    <td width="5%"></td>
					                                    <td width="70%" align="left" >
					                                    	<input type="radio" name="use_yn" value="Y" <c:if test="${autoVO.use_yn eq 'Y' }">checked="checked"</c:if> />예
					                                    	<input type="radio" name="use_yn" value="N" <c:if test="${autoVO.use_yn ne 'Y' }">checked="checked"</c:if> />아니오
														</td>
					                                </tr>
