...
$(document).ready(function(){
	...
	$("#changeorderbtn").click(function(){
		...
		if(confirm("다음의 순서로 정하시겠습니까?")){
			...
			var postUrl = "<%=webRoot%>/admin/gpack/event/changeGpackPlaylistOrder.do";
			$.post(  postUrl, 
					 {pack_id : pack_id, category_id : category_id, playlist_ids : optionarray, smartUXManager : smartUXManager},
					  function(data) {
						 	...
						 	if(flag == "0000"){						// 정상적으로 처리된 경우
						 		alert("순서를 재지정했습니다");
						 		location.href="<%=webRoot%>/admin/gpack/event/getGpackPromotionPlaylistView.do?pack_id=" + pack_id + "&category_id=" + category_id;
						 	}else{
						                                ...
						                                <td height="25">
						                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
						                                        ...
						                                        <c:if test="${promotionVO ne null}"><c:if test="${promotionVO.category_nm ne ''}">
						                                            ...
						                                            <td width="15"><img src="/smartux_adm/images/admin/blt_07.gif"></td>
						                                            <td class="bold">플레이리스트 순서 바꾸기</td>
						                                        </tr>
						                                    	</tbody>
						                                    </table>
						                                </td>
					                                    ...
					                                    <td width="40%">
					                                    	<select id="packlist" name="packlist" size="${fn:length(result)}" style="width:200px; height:200px;">
																<c:forEach var="item" items="${result}" varStatus="status">
																	<option value="${item.playlist_id}">${item.playlist_nm}</option>
																</c:forEach>
															</select>
														</td>
					                                    <td width="10%"></td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                            ...
						                            <tr>
						                                <td height="25" align="center">
						                                	...
						                                	<span class="button small blue" id="playlistbtn">플레이리스트 설정</span>	
