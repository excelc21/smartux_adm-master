	...
	$("#changeorderbtn").click(function(){
		...
		if(confirm("다음의 순서로 정하시겠습니까?")){
			...
			for(var i=0; i < size; i++){
				...
				var selval = $('#categorylist option').eq(i).val();
				optionarray.push(selval);
			}
			
			var smartUXManager = $("#smartUXManager").val();
			var postUrl = "<%=webRoot%>/admin/gpack/category/updateGpackCategoryOrderby.do";
			$.post(  postUrl, 
					 {pack_id : pack_id, category_id : optionarray, smartUXManager : smartUXManager},
					  function(data) {
						                ...
						                <tr>
						                    <td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
					                                ...
					                                <tr align="center">
					                                    <td width="40%">
					                                    	<select id="categorylist" name="categorylist" size="${fn:length(result)}" style="width:200px; height:200px;">
