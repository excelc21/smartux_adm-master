                    				...
                    				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                ...
						                <tr>
						                    <td>
						                        ...
						                        <form id="form1" name="form1" action="./insertTermsProc.do" method="post" enctype="multipart/form-data">
					                                ...
					                                <tbody>				                             	
						                                <tr align="center">
						                                    ...
						                                    <td width="70%" align="left" >
																<select name="terms_gbn" id="terms_gbn">
																	<option value="1">이용약관</option>
																	<option value="2">개인정보 보호 정책</option>
																</select>		
															</td>
														 </tr>				                             	
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="title" id="title" size="35" style="font-size: 12px;" value="" onKeyUp="checkByte($(this),'256')"/>
															</td>
														 </tr>
														 <tr align="center">
														 ...
														 <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<select name="service_gbn" id="service_gbn">
																	<option value="0">서비스중</option>
																	<option value="1">변경예정</option>
																</select>		
															</td>
														 </tr>		
						                                <tr align="center">
						                                ...
						                                <tr align="center" >
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >								                                  
																<textarea rows="30" cols="52" name="terms_text" id="terms_text" ></textarea>
																  <br>[\f, !^, \b, \f88, \f99]  사용제한							
															</td>
						                                </tr>
													</tbody>
