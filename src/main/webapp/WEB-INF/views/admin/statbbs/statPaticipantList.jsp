...
$(document).ready(function(){
	$("#statExcelBtn").click(function(){
		...
		$(location).attr("href", "./excelPaticipantList.do?stat_no=${vo.stat_no}");
		$.unblockUI();
	});
});
</script>
			                            ...
			                            <td>
			                                ...
			                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="search_table">
			                                	...
			                                	<tr>
				                                    ...
				                                    <td>
				                                    	<form id="form2" method="get" action="statPaticipantList.do"> 
					                                    <table border="0" cellpadding="0" cellspacing="0" width="450">		                                    
		                                        			...
		                                        			<tr>
					                                            ...
					                                            <td>
					                                            	<select class="select" id="stat_no" name="stat_no">
																		<c:forEach items="${sbox_vo}" var="s_rec">
																	    	<option value="${s_rec.stat_no}" <c:if test="${s_rec.stat_no==vo.stat_no}">selected</c:if> >${s_rec.title}</option>
										                            	</c:forEach>
					                                                </select>
					                                            	&nbsp;&nbsp;&nbsp;
					                                            </td>					
						                ...
						                <tr>
						                    <td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="board_list">
					                                <tbody>
					                                <tr align="center">
					                                    <th scope="col">참여통계 명</th>
					                                    <th scope="col" width="15%">가번</th>
					                                    <th scope="col" width="15%">가맥</th>
					                                    <th scope="col" width="13%">전화번호</th>
					                                    <th scope="col" width="13%">참여일</th>
					                                </tr>
					                            	...
					                            	<c:set var="i" value="${i+1}" />
						                            	<tr align="center">
						                                    <td class="table_td_04" align="left">${rec.title}</td>
						                                    <td class="table_td_04">${rec.sa_id}</td>
						                                    <td class="table_td_04">${rec.mac}</td>
						                                    <td class="table_td_04">${rec.ctn}</td>
						                                    <td class="table_td_04">${rec.r_date}</td>
						                                </tr>
					                            	</c:forEach>
					                            	</tbody>
					                            </table>
						                            ...
						                            <tr>
						                            	<td align="center">
						                            		<jsp:include page="/WEB-INF/views/include/naviControll.jsp">
																<jsp:param value="statPaticipantList.do" name="actionUrl"/>
																<jsp:param value="?stat_no=${vo.stat_no}" name="naviUrl" />
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                            ...
						                            <tr>
						                                <td align="right">
						                                	<span class="button small blue" id="statExcelBtn">엑셀출력</span>
						                                </td>
						                            </tr>
						                       		</tbody>
						                       	</table>
