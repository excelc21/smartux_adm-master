                    				...
                    				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                ...
						                <tr>
						                    <td>
						                        ...
						                        <form id="form1" action="./statbbsUpdateProc.do" method="post">
					                            <table border="0" cellpadding="0" cellspacing="0" width="660" class="board_data">
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="70%" align="left" >
															<input type="hidden" id="stat_no" name="stat_no" value="${vo.stat_no}"/>
															<input type="hidden" id="findName" name="findName" value="${vo.p_findName}" />
															<input type="hidden" id="findValue" name="findValue" value="${vo.p_findValue}" />
															<input type="hidden" id="pageNum" name="pageNum" value="${vo.p_pageNum}" />
															<input type="hidden" id="p_use_yn" name="p_use_yn" value="${vo.p_use_yn}" />	
															<input type="text" id="title" name="title" size="35" onKeyUp="checkByte($(this),'50')" style="font-size: 12px;" value="${vo.title}"/>								
														</td>
					                                </tr>
					                                <tr align="center">
					                                    <th width="25%">*내용</th>
					                                    <td width="5%"></td>
					                                    <td width="70%" align="left" >							                                  
															<textarea rows="10" cols="40" name="content" id="content" onKeyUp="checkByte($(this),'2000')" >${vo.content}</textarea>
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="5%"></td>
					                                    <td width="70%" align="left" >
															<input type="text" id="e_date" name="e_date" width="95%" value="${vo.e_date}">			
														</td>
					                                </tr>
					                                <tr align="center">
					                                    <th width="25%">*사용여부</th>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="660" align="left">
						                            ...
						                            <tr>
						                                <td height="25" align="right">
						                                	<span class="button small blue" id="submitBtn">수정</span>
