...
function makeDUI(){
	var html = [], h=-1;
	html[++h] = "<table id=\"dtable\" border=\"0\">\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td colspan=\"2\"><span class=\"button small blue\" id=\"adddweight\">추가</span></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td align=\"center\">가중치</td>\n";
	html[++h] = "<td></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "<tr>\n";
...
function makePUI(){
	var html = [], h=-1;
	html[++h] = "<table id=\"ptable\" border=\"0\">\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td colspan=\"3\"><span class=\"button small blue\" id=\"addpweight\">추가</span></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td align=\"center\">시작가격</td>\n";
	html[++h] = "<td align=\"center\">끝가격</td>\n";
	html[++h] = "<td align=\"center\">가중치</td>\n";
	html[++h] = "<td align=\"center\"></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td><input type=\"text\" name=\"pstart\" readonly value=\"0\"/></td>\n";
...
function makeCUI(){
	var html = [], h=-1;
	html[++h] = "<table id=\"ctable\" border=\"0\">\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td align=\"center\">유료</td>\n";
	html[++h] = "<td><input type=\"text\" id=\"cweight\"/></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "<tr>\n";
	html[++h] = "<td align=\"center\">무료</td>\n";
	html[++h] = "<td><input type=\"text\" id=\"fweight\"/></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "</table>\n";
...
function makeGUI(){
	...
	html[++h] = "<tr>\n";
	html[++h] = "<td>\n";
	html[++h] =	"<input type=\"text\" name=\"tgenre\" id=\"tgenre" + rowidcnt + "\"/>\n";
	html[++h] =	"<input type=\"hidden\" name=\"hgenre\" id=\"hgenre" + rowidcnt + "\">\n";
	html[++h] =	"</td>\n";
	html[++h] = "<td><input type=\"text\" name=\"gweight\"/></td>\n";
	html[++h] = "<td><span class=\"button small blue\" name=\"delrowbtn\">삭제</span></td>\n";
	html[++h] = "<td><span class=\"button small blue\" name=\"selgenrebtn\" onclick=\"selgenre('genre" + rowidcnt + "', 'hgenre" + rowidcnt + "')\">장르선택</span></td>\n";
	html[++h] = "</tr>\n";
	html[++h] = "</table>\n";
						                ...
						                <tr>
						                    <td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="600" class="board_data">
					                                ...
					                                <tr align="center">
					                                   <td colspan="3" id="uiarea">작업영역</td> 
					                                </tr>
