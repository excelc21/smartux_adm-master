...
$(document).ready(function(){
	...
	$("#regbtn").click(function(){
		...
		if(schedule_name == ""){
			...
			$.post("<%=webRoot%>/admin/schedule/insertSchedule.do", 
					 {schedule_name : schedule_name, album_id : albumarray, category_id : categoryarray, smartUXManager : smartUXManager, category_gb : category_gb, test_id : test_id, variation_id : variation_id},
					  function(data) {
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="board_data">
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="24%" align="left" >
															<input type="text" id="schedule_name" name="schedule_name" size="35" maxlength="100" style="font-size: 12px;" />								
														</td>
					                                    <th width="25%">테스트 ID</th>
					                                    <td width="1%"></td>
					                                    <td width="14%" align="left" >
															<input type="text" id="test_id" name="test_id" size="35" maxlength="32" style="font-size: 12px;" />								
														</td>
														<td>&nbsp;</td>
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="24%" align="left" colspan="3">
															<input type="text" id="variation_id" name="variation_id" size="35" maxlength="32" style="font-size: 12px;" />								
														</td>
					                                </tr>
					                                <tr align="center">
