																...
																<table border="0" cellpadding="0" cellspacing="0" width="660" align="left">
																	...
																	<tr>
																		<td height="25" align="right">
																			<a href="./list.do?findName=${vo.findName}&findValue=${vo.findValue}&pageNum=${vo.pageNum}&status=${vo.status}&paType=${vo.paType}&startDt=${vo.startDt}&endDt=${vo.endDt}&discount_div=${vo.discount_div}&mtype=${vo.mtype}">
