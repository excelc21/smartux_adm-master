...
$(document).ready(function(){
	...
	$("#updbtn").click(function(){
		...
		/* var badge_img_file = $("#badge_img_file").val();
		var badge_img_file_nm = $("#badge_img_file_nm").val(); */
		//variation_id추가
		...
		if(newTitle_nm == ""){
			...
			/* formData.append("badge_img_file_nm", badge_img_file_nm); */
			//variation_id추가
			...
			/* if(badge_img_file != ""){
				formData.append("badge_img_file", $("#badge_img_file")[0].files[0]);
			} */
			formData.append("abtest_yn", abtest_yn);

			$.ajax({
				url: '/smartux_adm/admin/abtest/updatePaperInfo.do',
				data: formData,
				processData: false,
				contentType: false,
				async: false,
...
function deleteImage(chImg){
	if(confirm("이미지를 삭제하시겠습니까?")){
		...
		/* else if(chImg == "5"){
			$("#badge_img_file_nm").attr("value","");
			$("#badge_img_file_del").remove();
		} */
	}
}
                    				...
                    				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                ...
						                <tr>
						                    <td>
						                        ...
						                        <input type=hidden name="variation_id" id="variation_id" value="${variation_id}" />
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="board_data">
					                               ...
					                               <%-- <tr align="center">
					                                    <th width="30%">뱃지 이미지</th>
					                                    <td width="5%"></td>
					                                    <td width="65%" align="left" >
					                                    	<input type="file" id="badge_img_file" name="badge_img_file" value="">
					                                    	<c:if test="${not empty result.badge_img_file }">
					                                    		<div id="badge_img_file_del">																			
																	  <br><a href="javascript:winopen('${result.img_url}${result.badge_img_file }','200','300')">${result.badge_img_file}</a>									 
																	<a href="javascript:deleteImage('5')"><span class="button small rosy">삭제</span></a>
																</div>
																<input type="hidden" id="badge_img_file_nm" name="badge_img_file_nm" value="${result.badge_img_file}">
					                                    	</c:if>
														</td>
					                                </tr> --%>
					                                ...
					                                <tr align="center">
					                                    <th width="30%">AB TEST 지면여부</th>
					                                    <td width="5%"></td>
					                                    <td width="65%" align="left" >
						                                    <c:choose>
																<c:when test="${result.abtest_yn == 'Y'}">
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
						                            ...
						                            <tr>
						                                ...
						                                <c:if test="${result.del_yn ne 'Y' && abmsUptFlag}">
