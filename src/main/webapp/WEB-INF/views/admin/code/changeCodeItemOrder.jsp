...
$(document).ready(function(){
	...
	$("#changeorderbtn").click(function(){
		...
		if(confirm("다음의 순서로 정하시겠습니까?")){
			...
			$.post("<%=webRoot%>/admin/code/changeCodeItemOrder.do", 
					 {code : code, item_code : optionarray, smartUXManager : smartUXManager},
					  function(data) {
						                ...
						                <tr>
						                    <td>
						                                ...
						                                <td height="25">
						                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
						                                        ...
						                                        <tr>
						                                            ...
						                                            <td class="bold">SmartUX 코드값 순서 바꾸기</td>
						                                        </tr>
						                                    	</tbody>
						                                    </table>
						                                </td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
					                                ...
					                                <tr align="center">
					                                    <td width="40%">
					                                    	<select id="codeitemlist" name="codeitemlist" size="${fn:length(result)}" style="width:150px;height:200px;">
