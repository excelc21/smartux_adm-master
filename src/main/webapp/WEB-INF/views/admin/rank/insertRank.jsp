...
$(document).ready(function(){
	...
	$("#selRulebtn").click(function(){
		var url = window.open("<%=webRoot%>/admin/rank/selectRulePopup.do?ruleCheck=Y", "selectRulePopup","width=460,height=424,resizable=yes,scrollbars=yes"); 
		url.moveTo(530,100);
	});	
	...
	$("#regbtn").click(function(){	
		...
		if(rank_term == ""){
			...
			$.post("<%=webRoot%>/admin/rank/insertRank.do", 
					 {rank_term : rank_term, rank_name : rank_name, hgenre : hgenre, rule_name : rule_name , smartUXManager : smartUXManager, category_gb : category_gb},
					  function(data) {
						 	// 결과 코드를 받아 결과 코드에 따라 메시지를 보여준다
						 	var flag = data.flag;
						 	var message = data.message;
						 	...
						 	if(flag == "0000"){						// 정상적으로 처리된 경우
						 		opener.location.reload();
								alert("랭킹 데이터가 등록되었습니다");
								self.close();
						 	}else{
						 		if(flag == "9000"){
						 				alert("현재 등록하고자 하는 랭킹명 " + rank_name + "은 이미 등록되어 있는 랭킹 명입니다\n다른 랭킹명을 사용해주세요");
						 				$("#rank_name").focus();
						 		}else{
						 			alert("작업 중 오류가 발생하였습니다\nflag : " + flag + "\nmessage : " + message);
						 		}
						                                ...
						                                <td height="25">
						                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
						                                        ...
						                                        <tr>
						                                            ...
						                                            <td class="bold">VOD 랭킹 데이터 등록</td>
						                                        </tr>
						                                    	</tbody>
						                                    </table>
						                                </td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="450" class="board_data">
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="74%" align="left" >
															<input type="text" id="rank_term" name="rank_term" value="7" size="35" maxlength="100" style="font-size: 12px;" />								
														</td>
					                                </tr>					                                
					                                <tr align="center">
					                                    ...
					                                    <td width="1%"></td>
					                                    <td width="74%" align="left" >
															<input type="text" id="rank_name" name="rank_name" size="35" maxlength="100" style="font-size: 12px;" />																	
														</td>
					                                </tr>
					                                <tr align="center">
					                                    ...
					                                    <td width="1%"></td>
					                                    <td width="74%" align="left" >
															<input type="text"   id="tgenre"  name="tgenre"  maxlength="100" size="35" style="font-size: 12px;" />
															<input type="hidden" id="hgenre"  name="hgenre"  maxlength="100"  />
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="1%"></td>
					                                    <td width="74%" align="left" >
					                                    	<input type="text" id="rule_name_on" name="rule_name_on" size="35" maxlength="100" style="font-size: 12px;" />
															<input type="hidden" id="rule_name" name="rule_name" size="35" maxlength="100"  />
