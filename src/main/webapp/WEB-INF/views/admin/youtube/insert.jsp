...
$(document).ready(function(){
	$("#regbtn").click(function(){
		...
		if(category == ""){
			...
			$.post("<%=webRoot%>/admin/youtube/insert.do", 
					 {category : category, recommend_text : recommend_text, write_id : write_id},
					  function(data) {
					                                ...
					                                <tr align="center">
					                                    ...
					                                    <td width="74%" align="left" >
															<select id="category" name="category">
																<option value="q"><%=SmartUXProperties.getProperty("Youtube.category.q") %></option>
																<option value="v"><%=SmartUXProperties.getProperty("Youtube.category.v") %></option>
																<option value="vv"><%=SmartUXProperties.getProperty("Youtube.category.vv") %></option>
																<option value="p"><%=SmartUXProperties.getProperty("Youtube.category.p") %></option>
															</select>								
														</td>
					                                </tr>					                                
					                                <tr align="center">
					                                    ...
					                                    <td width="1%"></td>
					                                    <td width="74%" align="left" >
															<input type="text" id="recommend_text" name="recommend_text" size="45" maxlength="100" style="font-size: 12px;" />																	
														</td>
					                                </tr>
							                       	</tbody>
					                            </table>
