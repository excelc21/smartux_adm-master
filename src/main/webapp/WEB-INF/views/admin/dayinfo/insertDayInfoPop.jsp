																			...
																			<tbody>
																				...
																				<tr>
																					<td>
																						...
																						<form id="sForm" name="sForm" method="POST" action="./insertDayInfoProc.do">
																							<table border="0" cellpadding="0" cellspacing="0" width="100%" class="board_data">
																								<tbody>
																									<tr>
																										...
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" name="message" id="message" style="font-size: 12px;width:95%" maxlength="1200" value=""/>	
																									...
																									<tr>
																										...
																										<td align="left">
																											<select class="select" id="display_type" name="display_type">
																	                                    		<option value="1" name="1">절기</option>
																	                                    		<option value="2" name="1">절일</option>
																	                                    		<option value="3" name="1">잡절</option>
																	                                    		<option value="4" name="2">명언</option>
																	                                    		<option value="5" name="2">아름다운 우리말</option>
																	                                    		<option value="6" name="2">명언2</option>
															                                                </select>
																										</td>
																									</tr>
																									<tr>
																										...
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" name="display_time" id="display_time" style="font-size: 12px;width:40px;text-align:right;" class="numeric" maxlength="4" value=""/>
																										</td>
																									</tr>
																									<tr id="trDate1">
																										<th width="25%">날짜</th>
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" id="display_date1" name="display_date1" size="10" style="text-align: center" class="dpDate" value="">
																										</td>
																									</tr>
																									<tr id="trDate2" style="display:none;">
																										<th width="25%">날짜</th>
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" id="display_date2" name="display_date2" size="10" style="text-align: center" class="dpDate" value="">
																										</td>
																									</tr>
																									<tr>
																										<th width="25%">화자</th>
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" name="speaker" id="speaker" style="font-size: 12px;width:120px" value=""/>	
																										</td>
																									</tr>
																									<tr>
																										<th width="25%">추가내용</th>
																										<td width="2%">&nbsp;</td>
																										<td align="left">
																											<input type="text" name="etc" id="etc" style="font-size: 12px;width:95%" value=""/>	
																										</td>
																									</tr>
																								</tbody>
																							</table>
																							<table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
																								<tbody>
																									<tr>
																										<td height="40" align="right"><input type="submit" value="등록" class="button small blue"/> 
