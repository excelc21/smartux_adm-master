...
$(document).ready(function(){
	...
	typeChange(document.getElementById("content_type"));
		    ...
		    success: function(data){
				...
				if(flag == "0000"){
			    	if(chkCnt == "0"){
			    	    ...
			    	    if($('#content_type').val() != 'C' && $("#parent_id").val() == ''){
			    			alert('상위 컨텐츠ID를 선택해 주세요.');
			    			$("#parent_id").focus();
			    			return;	
			    		}
			    		...
			    		if(confirm("중복된 아이디입니다. 컨텐츠 아이디를 새로 갱신하시겠습니까?")){
			    			$('#content_id').val(data.result.content_id);
			    		}
			    	}
				}else{
			    	$.unblockUI();
	...
	$("#searchBtn").click(function(){
		var url = "<%=webRoot%>/admin/hotvod/openCategoryPop.do?content_type=C";
...
function resetValue(){
	...
	$('#site_id').val('');
   	...
   	$('#end_dt').val('');	  
	$('#hit_cnt').val('');	//조회수 초기화
	$('#content_name').val('');	//컨텐츠 명 초기화
   	
	//2019.11.12 브릿지홈 개편 :값 초기화 추가
	$('#hv_ui_type').val('');	//UI타입 값 초기화
...
//isAds=Y -> 팝업창에서 카테고리 구분을 선택하려면 isCategoryGbUse =Y로 호출해야함
                    				...
                    				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						                ...
						                <tr>
						                    <td>
						                        ...
						                        <form id="form1" name="form1" action="./contentInsert.do" method="post" enctype="multipart/form-data">
					                                ...
					                                <tbody>
					                                	...
					                                	<tr align="center" id="view_tr" style="display: none">
						                                    ...
						                                    <td width="70%" align="left" >
																<input type="text" name="start_dt" id="start_dt" size="19" onKeyUp="checkByte($(this),'19');checkNumAndColon(this);" style="font-size: 12px;"/> ~ <input type="text" name="end_dt" id="end_dt" size="19" onKeyUp="checkByte($(this),'19');checkNumAndColon(this);" style="font-size: 12px;"/>
						                                ...
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="content_id" id="content_id" size="10" value="${vo.content_id}" style="font-size: 12px;" onKeyUp="checkKeyIn($(this),'${vo.content_id}')"/>
															</td>													
						                                </tr>
						                                <!-- 컨텐츠 구분 -->
						                                <tr align="center"  >
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<select id="content_type" name="content_type" onchange="typeChange(this);">
																	<option value="C">카테고리</option>
																	<option value="V" selected>컨텐츠</option>
																	<option value="M">VOD 상세</option>
																	<option value="N">VOD 카테고리</option>
																	<option value="L">링크 URL</option>
																</select>
															</td>
						                                </tr>
						                                <tr align="center" id="service_type_tr" style="display: none">
															...
															<td width="70%" align="left">
											                    ...
											                    <input type="hidden" name="multi_service_type" id="multi_service_type" value="" >
														...
														<tr align="center" id="test_yn" style="display: none">
															...
															<td width="5%"></td>
															<td width="70%" align="left">
																<label><input type="radio" name="test_yn" value="N" checked="checked">전체</label>
																<label><input type="radio" name="test_yn" value="Y">검수단말기 전용</label>
																<label><input type="radio" name="test_yn" value="S">상용단말기 전용</label>
															</td>
														</tr>
														<!-- 통합 검색 여부 -->
														<tr align="center" id="unify_search_yn" style="display: none">
															...
															<td width="5%"></td>
															<td width="70%" align="left">
																<label><input type="radio" name="unify_search_yn" value="Y" checked="checked">허용</label>
																<label><input type="radio" name="unify_search_yn" value="N">미허용</label>
															</td>
														</tr>
														<!-- 뱃지 -->						                                
						                                <tr align="center" >
						                                    ...
						                                    <td width="70%" align="left">
						                                    	<hotvod:badge-input/>
				                                  		 		<input type="hidden" name="badge_data" id="badge_data" size="50" value="" style="font-size: 12px;" >
															</td>  											
						                                </tr>
						                                
														<!-- 2019.11.06 브릿지홈 개편 : UI타입 선택 추가 -->
														<tr align="center"  class="contentTypeM contentTypeN" style="display: none">
					                                		<th width="25%">UI타입</th>
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="hv_ui_type" id="hv_ui_type" size="5" style="font-size: 12px;" readonly="readonly"/>
						                                ...
						                                <tr align="center" >
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
				                                   		 		<input type="text" name="content_name" id="content_name" size="50" value="" style="font-size: 12px;" onKeyUp="checkByte($(this),'100')">								                                   			       
															</td>													
						                                </tr>
						                                <!-- 컨텐츠URL -->
						                                <tr align="center" class="contentTypeA">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
				                                   		 		<input type="text" name="content_url" id="content_url" size="50" value="" style="font-size: 12px;" onKeyUp="checkByte($(this),'512')">
															</td>													
						                                </tr>
						                                <!-- 컨텐츠 설명 -->
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<textarea rows="10" cols="40" name="content_info" id="content_info" style="font-size: 12px;" onKeyUp="checkByte($(this),'255')" ></textarea>
															</td>
						                                </tr>
						                                <!-- 이미지 파일 IPTV에서는 사용안함 -->
						                                <%-- <tr align="center" class="contentTypeA hdtvImgContentTypeA">
						                                    <th width="25%" id="hdtv_image">컨텐츠 이미지( HDTV )</th>
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
			                                			...
			                                			<tr align="center" class="contentTypeA contentTypeN contentTypeM">
						                                    <th width="25%" id="iptv_image">컨텐츠 이미지( IPTV )</th>
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
						                                ...
						                                <tr align="center" class="contentTypeA" id="duration_tr">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
						                                    	<input type="text" name="duration" id="duration" size="10"  value=""/>																		
															</td>													
						                                </tr>
						                                 <!-- 출처 사이트-->
						                                <tr align="center" class="contentTypeA">
						                                    ...
						                                    <td width="70%" align="left" >
																<select name="site_id" id="site_id">
																	...
																	<c:forEach items="${siteList }" var="list">
																		<option value="${list.site_id}">${list.site_name }</option>
																	</c:forEach>
																</select>																			
															</td>													
						                                </tr>
					                                	...
					                                	<tr align="center" class="contentTypeB contentTypeM" style="display: none">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="album_id" id="album_id" size="20" style="font-size: 12px;" readonly="readonly"/>
																<input type="hidden" name="choiceCts" id="choiceCts" value="" />
																<input type="hidden" name="still_img" id="still_img" value="" />
																<span class="button small blue" id="searchAlbumBtn">검색</span>
															</td>
					                                	</tr>
						                                <!-- 카테고리ID -->
						                                <!-- 2019.11.06 브릿지 홈 개편 : IMCS 카테고리 ID 검색버튼 추가  -->
					                                	<tr align="center" class="contentTypeB contentTypeN contentTypeM" style="display: none">
					                                		<th width="25%">카테고리ID</th>
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="category_id" id="category_id" size="20" style="font-size: 12px;" readonly="readonly"/>
																<span class="button small blue" id="searchAlbumCateBtn" onclick="getVodCategoryPop()">검색</span>
																<span id="category_nm"></span>
															</td>
					                                	</tr>
					                                	<!-- 시리즈명 -->
					                                	<tr align="center" class="contentTypeB contentTypeM" style="display: none">
					                                	...
					                                	<!-- 컨텐츠 이미지 IPTV에서는 사용안함-->
					                                	<!-- <tr align="center" class="contentTypeB contentTypeC">
						                                    <th width="25%">컨텐츠 이미지</th>
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="file" id="file_hl"  accept="image/*" name="file_hl" value="파일선택" />
															</td>
			                                			</tr> -->
					                                	<!-- 상영시간 -->
					                                	<tr align="center" class="contentTypeB" style="display: none" id="duration_trB">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="start_time" id="start_time" size="10" onKeyUp="checkByte($(this),'8');checkNumAndColon(this);inputColon(this);" style="font-size: 12px;"/> ~ <input type="text" name="end_time" id="end_time" size="10" onKeyUp="checkByte($(this),'8');checkNumAndColon(this);inputColon(this);" style="font-size: 12px;"/>
															</td>
					                                	</tr>
						                                 <!-- 상위 컨텐츠ID -->
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
						                                    	<input type="text" name="parent_id" id="parent_id" size="10" style="font-size: 12px;" value="" readonly="readonly"/>
						                                ...
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="content_order" id="content_order" size="15" onKeyUp="checkByte($(this),'15');checkNum(this);" style="font-size: 12px;" value=""/>																		
															</td>
						                                </tr>
						                                <!-- 조회수-->
						                                <tr align="center">
						                                    ...
						                                    <td width="5%"></td>
						                                    <td width="70%" align="left" >
																<input type="text" name="hit_cnt" id="hit_cnt" size="15" onKeyUp="checkByte($(this),'15');checkNum(this);" style="font-size: 12px;" value="">												 							
															</td>
						                                </tr>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="660" align="left">
						                            ...
						                            <tr>
						                                <td height="25" align="right">
						                                	...
						                                	<a href="./contentList.do?findName=${vo.findName}&findValue=${vo.findValue}&pageNum=${vo.pageNum}&serviceType=${vo.serviceType}&isLock=${vo.isLock}"><span class="button small blue">목록</span></a>
						                                </td>
						                            </tr>
						                       		</tbody>
						                       	</table>
