...
$(document).ready(function(){
	...
	$("#changeorderbtn").click(function(){
		...
		if(confirm("다음의 순서로 정하시겠습니까?")){
			...
			var postUrl = "<%=webRoot%>/admin/greeting/order/update.do";
			$.post(  postUrl, 
					 {code : optionarray},
					  function(data) {
						                ...
						                <tr>
						                    <td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
					                                ...
					                                <tr align="center">
					                                    <td width="40%">
					                                    	<select id="packlist" name="packlist" size="${fn:length(list)}" style="width:200px; height:200px;">
																<c:forEach var="item" items="${list}" varStatus="status">
																	<option value="${item.greeting_id}">${item.greeting_txt}</option>
																</c:forEach>
															</select>
														</td>
					                                    <td width="10%"></td>
					                                    <td width="*" align="left" >
															<span class="button small blue" id="topbtn">맨위</span><br/><br/>
					                                    	<span class="button small blue" id="upbtn">위로</span><br/><br/>
															<span class="button small blue" id="downbtn">아래로</span><br/><br/>
															<span class="button small blue" id="bottombtn">맨아래</span>
														</td>
					                                </tr>
					                            	</tbody>
					                            </table>
