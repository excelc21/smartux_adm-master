...
$(document).ready(function(){
	...
	$("#changeorderbtn").click(function(){
		...
		if(confirm("다음의 순서로 정하시겠습니까?")){
			...
			$.post("<%=webRoot%>/admin/mainpanel/changePanelTitleTempOrder.do", 
						                ...
						                <tr>
						                    <td>
					                            ...
					                            <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
					                                ...
					                                <tr align="left">
					                                    <td width="40%">
					                                    	<%-- <select id="titlelist" name="titlelist" size="${fn:length(result)}" style="width:150px;height:200px;">
																<c:forEach var="item" items="${result}" varStatus="status">
																	<option value="${item.title_id}">${item.title_nm}</option>
																</c:forEach>
															</select> --%>
															<c:if test="${result == '[]' }">
