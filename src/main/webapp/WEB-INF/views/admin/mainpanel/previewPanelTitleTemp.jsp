...
$(document).ready(function(){
	...
	//setTimeout("imgResize()",3000);		// 이미지 로딩이 느릴경우 1초(1000) 이상의 값을 줘서 변화를  시도해볼것
});
...
function callDraw(){
	...
	var separator = "<br/>";
	$.post("<%=webRoot%>/admin/mainpanel/previewPanelTitleTemp.do", 
...
function showImgPopup(_src){
	window.open("/smartux_adm/admin/mainpanel/showImgPopup.do?src="+_src);
}
