...
function fn_change_page(pageNum){
	$("#pageNum").val(pageNum);
	$("#srchfrm").submit();
}
...
<body>
<fmt:formatNumber var="pageNum" value="<%=pageNum%>"  pattern="000" />
<fmt:formatNumber var="startPage" value="<%=startPage%>"  pattern="000" />
<fmt:formatNumber var="endPage" value="<%=endPage %>"  pattern="000" />
<fmt:formatNumber var="blockSize" value="<%=blockSize%>"  pattern="000" />
<fmt:formatNumber var="pageCount" value="<%=pageCount%>"  pattern="000" />
...
<c:choose>
	...
	<c:otherwise>
		<a href="javascript:fn_change_page('${1}');"><img src='/smartux_adm/images/admin/prev_icon_02.gif' alt='맨앞' /></a>
	</c:otherwise>
</c:choose>
<c:choose>
	...
	<c:otherwise>
		<a href="javascript:fn_change_page('${pageNum - 1}');" title="이전페이지" class="span"><img src='/smartux_adm/images/admin/prev_icon_01.gif' alt='이전페이지' /></a>
	</c:otherwise>
</c:choose>
<%
...
%>
			<a href="javascript:fn_change_page('<%=i%>');" title="<%=i%>"><%=i%></a>
<%		
		}		
...
<c:choose>
	...
	<c:otherwise>
		<a href="javascript:fn_change_page('${pageNum+1}');" title="다음페이지" class="span"><img src='/smartux_adm/images/admin/next_icon_01.gif' alt='다음페이지' /></a>
	</c:otherwise>
</c:choose>
<c:choose>
	...
	<c:otherwise>
		<a href="javascript:fn_change_page('${pageCount}');"><img src='/smartux_adm/images/admin/next_icon_02.gif' alt='맨뒤' /></a>
	</c:otherwise>
</c:choose>
</body>
</html>
